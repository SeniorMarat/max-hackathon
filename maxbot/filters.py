...
class CommandFilter(Filter):
    ...
    def __init__(self, commands: Optional[Union[str, List[str]]] = None):
        if commands:
            ...
            self.commands = [
                cmd if cmd.startswith("/") else f"/{cmd}" for cmd in self.commands
            ]
        else:
            self.commands = None
...
class F:
    ...
    @staticmethod
    def text(
        text: Optional[Union[str, List[str]]] = None, contains: Optional[str] = None
    ) -> TextFilter:
        """Filter by text"""
    ...
    @staticmethod
    def callback_data(
        data: Optional[Union[str, List[str]]] = None, startswith: Optional[str] = None
    ) -> CallbackDataFilter:
