...
import logging
import time
from typing import Optional, Callable, List, Any, Union, Awaitable

from .bot import Bot
from .types import Update, UpdateType, Message, Callback
from .filters import Filter, CommandFilter, TextFilter, CallbackDataFilter
...
class Handler:
    ...
    async def handle(self, update: Update, bot: Bot) -> Any:
        ...
        if update.update_type in [UpdateType.MESSAGE_CREATED, UpdateType.MESSAGE_EDITED]:
